        ...
        if (!DatabaseLoaded){
            try{
                ...
                for (i = 0; i < n; i++){
                    ...
                    if (HLAnames.get(i).equals("HLA_A*110101"))
                        j2 = i;
                    if (HLAnames.get(i).equals("HLA_A*0114"))
                        k2 = i;
                }
                out.printf("DONE!\n");
    ...
    public Integer map(RefMetaDataTracker tracker, ReferenceContext ref, AlignmentContext context) {
        ...
        if( context.getReads().size() > 0 ) {
            ...
            for (int i = 0; i < context.getReads().size(); i++) {
                ...
                if (mapquality >= 10 && BaseUtils.simpleBaseToBaseIndex(base) != -1) {
            ...
            if (DEBUG) {
                ...
                //out.printf("COV[%s]\t",G.getCoverage());
            }
            ...
            if (depth > 0){
                ...
                if ( DEBUG ){
                    ...
                    for ( DiploidGenotype g : DiploidGenotype.values() ) {
                        out.printf("%s %5.0f\t",g.toString(),G.getLikelihood(g)-homreflikelihood);
                    }
                    out.printf("\n");
                }
            }
